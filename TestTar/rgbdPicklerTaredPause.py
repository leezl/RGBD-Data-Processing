...
class TaredPickler:
    ...
    def __init__(self, dataDir = 'original/tared'):
        ...
        if not os.path.isfile(os.getcwd()+'/progressLog'):
            ...
            self.totalDictionary = diction['totalDictionary']
    ...
    def main_pickler(self):
        ...
        for index in range(otherI, len(self.fileList)):
            ...
            #print "openning tarfile "+str(path)
            ...
            if depth != None and mask != None:
                ...
                labels.append(self.list_dictionary.index(name))
                #display_color(mask)
                # find cropping
    ...
    def signal_handler(self, signal, frame):
        ...
        if self.pickling:
            ...
            #load totalDictionary
            diction['totalDictionary'] = self.totalDictionary
            #load list_dictionary
            ...
            diction = cPickle.dump(diciton, fo)
            fo.close()
        # else just exit
